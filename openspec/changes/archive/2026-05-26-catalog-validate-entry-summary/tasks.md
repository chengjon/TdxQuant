...
- [x] Add focused `catalog validate --view summary` test coverage for `entry_summary`.
- [x] Implement additive selected-entry summary projection in the catalog validation summary view.
