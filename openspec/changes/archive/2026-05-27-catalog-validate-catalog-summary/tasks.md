# catalog validate catalog summary tasks

## Implementation

- [x] Add focused `catalog validate --view summary` test coverage for compact `catalog_summary`.
- [x] Implement additive `catalog_summary` projection in the catalog validation summary view.
