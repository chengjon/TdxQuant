...
- [x] Add focused provider replay status and CLI summary view test coverage for `runtime.probe_summary.outcome_summary`.
- [x] Implement additive outcome summary projection in provider replay probe summaries.
