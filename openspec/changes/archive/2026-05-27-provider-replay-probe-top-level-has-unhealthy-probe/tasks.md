...
- [x] Add focused provider replay/CLI test coverage for top-level `has_unhealthy_probe`.
- [x] Implement additive top-level `runtime.probe_summary.has_unhealthy_probe`.
