...
- [x] Add focused direct/HTTP/CLI summary test coverage for `has_fresh_component`.
- [x] Implement additive `status_summary.governance.evaluation_summary.has_fresh_component`.
