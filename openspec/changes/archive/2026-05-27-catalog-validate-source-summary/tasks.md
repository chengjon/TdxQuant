# catalog validate source summary tasks

## Implementation

- [x] Add focused `catalog validate --view summary` test coverage for compact `source_summary`.
- [x] Implement additive `source_summary` projection in the catalog validation summary view.
