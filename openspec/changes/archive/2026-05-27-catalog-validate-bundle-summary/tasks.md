# catalog validate bundle summary tasks

## Implementation

- [x] Add focused `catalog validate --view summary` test coverage for compact `bundle_summary`.
- [x] Implement additive `bundle_summary` projection in the catalog validation summary view.
