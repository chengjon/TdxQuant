...
- [x] Add focused `catalog validate --view summary` test coverage for `bundle_step_summary`.
- [x] Implement additive selected-bundle step summary projection in the catalog validation summary view.
