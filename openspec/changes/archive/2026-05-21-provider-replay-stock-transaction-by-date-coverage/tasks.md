...
- [x] 1.1 Add failing fixture and runtime capability metadata tests for `transaction.stock_transaction_data_by_date`.
- [x] 1.2 Add failing replay provider and manager tests proving replay uses the default fixture without live calls.
- [x] 1.3 Add failing nested API and flat CLI replay tests for stock transaction by-date.

## 2. Implementation

- [x] 2.1 Add the stock transaction by-date fixture and fixture descriptor/default replay mapping.
