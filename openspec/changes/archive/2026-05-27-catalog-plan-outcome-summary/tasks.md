...
- [x] Add focused `catalog plan --view summary` test coverage for `plan_outcome`.
- [x] Implement additive plan outcome projection in catalog plan/preview summary views.
