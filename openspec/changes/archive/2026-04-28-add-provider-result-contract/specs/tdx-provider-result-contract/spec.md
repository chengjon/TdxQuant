...
#### Scenario: Successful synchronous result uses canonical envelope
- **WHEN** a synchronous provider-facing query or formula style call completes successfully
...
#### Scenario: Failed synchronous result uses canonical envelope
- **WHEN** a synchronous provider-facing call fails
...
#### Scenario: Capability-specific payload remains inside data
...
- **WHEN** a synchronous provider-facing result includes timestamps, symbols, or enums
