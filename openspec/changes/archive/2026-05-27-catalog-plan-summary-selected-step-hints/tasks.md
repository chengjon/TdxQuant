...
- [x] Add focused red coverage for top-level `plan_summary` step hint fields on `catalog plan --view summary`.
- [x] Implement additive read-only top-level `plan_summary` selected-step hint projection.
