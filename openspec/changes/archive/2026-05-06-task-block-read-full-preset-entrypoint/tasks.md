...
- [x] 1.1 Add a stable task-preset requirement for `block-read-full` to the task-management spec.
...
- [x] 3.1 Run `openspec validate task-block-read-full-preset-entrypoint --type change --strict`.
