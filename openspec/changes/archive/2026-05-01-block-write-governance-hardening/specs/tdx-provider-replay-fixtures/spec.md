...
- **AND** the fixture catalog MUST include representative `block` governance outcomes for at least applied, noop, and rejected mutation paths
...
- **AND** block mutation governance fixtures MUST preserve the stabilized `block_mutation` governance fields and audit-artifact descriptors
