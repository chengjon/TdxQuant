...
- [x] Add focused `catalog validate --view summary` test coverage for `validation_outcome`.
- [x] Implement additive validation outcome projection in catalog validation summary views.
