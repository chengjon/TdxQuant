...
- `audit-pingan-review`
  - 排障时先看最近失败台账，再回看当日平安券商 trade_audit 全状态复盘
...
- `audit-pingan-exception-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 rejected + failed trade_audit 异常复盘
- `audit-pingan-rejection-diagnostics`
  - 先看最近失败台账，再回看当日平安券商拒单 trade_audit 诊断复盘
...
- `audit-submit-once-rejection-diagnostics`
  - 先看最近失败台账，再回看当日 buy_submit_once rejected trade_audit 拒单诊断复盘
- `audit-submit-once-failure-diagnostics`
  - 先看最近失败台账，再回看当日 buy_submit_once failed trade_audit 失败诊断复盘
...
- `audit-pingan-submit-once-rejection-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 buy_submit_once rejected trade_audit 拒单诊断复盘
...
- `audit-sell-rejection-diagnostics`
  - 先看最近失败台账，再回看当日 sell rejected trade_audit 拒单诊断复盘
- `audit-sell-failure-diagnostics`
  - 先看最近失败台账，再回看当日 sell failed trade_audit 失败诊断复盘
...
- `audit-pingan-sell-rejection-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 sell rejected trade_audit 拒单诊断复盘
- `audit-pingan-sell-failure-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 sell failed trade_audit 失败诊断复盘
...
- `audit-order-rejection-diagnostics`
  - 先看最近失败台账，再回看当日 buy + sell rejected trade_audit 拒单诊断复盘
- `audit-order-failure-diagnostics`
  - 先看最近失败台账，再回看当日 buy + sell failed trade_audit 失败诊断复盘
...
- `audit-pingan-order-rejection-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 buy + sell rejected trade_audit 拒单诊断复盘
- `audit-pingan-order-failure-diagnostics`
  - 先看最近失败台账，再回看当日平安券商 buy + sell failed trade_audit 失败诊断复盘
...
- `submit-ready-complete-review`
  - 推进到提交确认前边界后继续查看当日成功成交日报和已确认 trade_audit 复盘
- `submit-ready-exception-review`
  - 推进到提交确认前边界后继续回看当日 rejected + failed trade_audit 异常复盘
- `submit-ready-pingan-audit-review`
  - 推进到提交确认前边界后回看当日平安券商 trade_audit 复盘
- `submit-ready-pingan-complete-review`
  - 推进到提交确认前边界后继续查看当日成功成交日报和当日平安券商已确认 trade_audit 复盘
- `submit-ready-pingan-exception-review`
  - 推进到提交确认前边界后继续回看当日平安券商 rejected + failed trade_audit 异常复盘
- `submit-ready-rejection-review`
  - 推进到提交确认前边界后继续回看当日 rejected trade_audit 拒单诊断复盘
- `submit-ready-failure-review`
  - 推进到提交确认前边界后继续回看当日 failed trade_audit 失败诊断复盘
- `submit-ready-pingan-rejection-review`
  - 推进到提交确认前边界后继续回看当日平安券商 rejected trade_audit 拒单诊断复盘
- `submit-ready-pingan-failure-review`
  - 推进到提交确认前边界后继续回看当日平安券商 failed trade_audit 失败诊断复盘
- `submit-ready-order-exception-review`
  - 推进到提交确认前边界后继续回看当日 buy + sell rejected + failed trade_audit 异常复盘
- `submit-ready-pingan-order-exception-review`
  - 推进到提交确认前边界后继续回看当日平安券商 buy + sell rejected + failed trade_audit 异常复盘
- `submit-ready-order-rejection-review`
  - 推进到提交确认前边界后继续回看当日 buy + sell rejected trade_audit 拒单诊断复盘
- `submit-ready-order-failure-review`
  - 推进到提交确认前边界后继续回看当日 buy + sell failed trade_audit 失败诊断复盘
- `submit-ready-pingan-order-rejection-review`
  - 推进到提交确认前边界后继续回看当日平安券商 buy + sell rejected trade_audit 拒单诊断复盘
- `submit-ready-pingan-order-failure-review`
  - 推进到提交确认前边界后继续回看当日平安券商 buy + sell failed trade_audit 失败诊断复盘
- `submit-ready-submit-path-exception-review`
  - 推进到提交确认前边界后继续回看当日 submit path rejected + failed trade_audit 异常复盘
- `submit-ready-pingan-submit-path-exception-review`
  - 推进到提交确认前边界后继续回看当日平安券商 submit path rejected + failed trade_audit 异常复盘
- `submit-ready-submit-path-rejection-review`
  - 推进到提交确认前边界后继续回看当日 submit path rejected trade_audit 拒单诊断复盘
- `submit-ready-submit-path-failure-review`
  - 推进到提交确认前边界后继续回看当日 submit path failed trade_audit 失败诊断复盘
- `submit-ready-pingan-submit-path-rejection-review`
  - 推进到提交确认前边界后继续回看当日平安券商 submit path rejected trade_audit 拒单诊断复盘
- `submit-ready-pingan-submit-path-failure-review`
  - 推进到提交确认前边界后继续回看当日平安券商 submit path failed trade_audit 失败诊断复盘
- `confirm-audit-review`
  - 推进当前确认框后继续回看当日 trade_audit 复盘
- `confirm-pingan-audit-review`
  - 推进当前确认框后继续回看当日平安券商 trade_audit 复盘
- `confirm-complete-review`
  - 推进当前确认框后继续查看当日成功成交日报和已确认 trade_audit 复盘
- `confirm-pingan-complete-review`
  - 推进当前确认框后继续查看当日成功成交日报和当日平安券商已确认 trade_audit 复盘
...
- `submit-once-rejection-review`
  - 完整提交流程后继续回看当日 buy_submit_once rejected trade_audit 拒单诊断复盘
- `submit-once-failure-review`
  - 完整提交流程后继续回看当日 buy_submit_once failed trade_audit 失败诊断复盘
- `submit-once-pingan-rejection-review`
  - 完整提交流程后继续回看当日平安券商 buy_submit_once rejected trade_audit 拒单诊断复盘
- `submit-once-pingan-failure-review`
  - 完整提交流程后继续回看当日平安券商 buy_submit_once failed trade_audit 失败诊断复盘
- `submit-once-order-exception-review`
  - 完整提交流程后继续回看当日 buy + sell rejected + failed trade_audit 异常复盘
- `submit-once-pingan-order-exception-review`
  - 完整提交流程后继续回看当日平安券商 buy + sell rejected + failed trade_audit 异常复盘
- `submit-once-order-rejection-review`
  - 完整提交流程后继续回看当日 buy + sell rejected trade_audit 拒单诊断复盘
- `submit-once-order-failure-review`
  - 完整提交流程后继续回看当日 buy + sell failed trade_audit 失败诊断复盘
- `submit-once-pingan-order-rejection-review`
  - 完整提交流程后继续回看当日平安券商 buy + sell rejected trade_audit 拒单诊断复盘
- `submit-once-pingan-order-failure-review`
  - 完整提交流程后继续回看当日平安券商 buy + sell failed trade_audit 失败诊断复盘
- `submit-once-submit-path-exception-review`
  - 完整提交流程后继续回看当日 submit path rejected + failed trade_audit 异常复盘
- `submit-once-pingan-submit-path-exception-review`
  - 完整提交流程后继续回看当日平安券商 submit path rejected + failed trade_audit 异常复盘
- `submit-once-submit-path-rejection-review`
  - 完整提交流程后继续回看当日 submit path rejected trade_audit 拒单诊断复盘
- `submit-once-submit-path-failure-review`
  - 完整提交流程后继续回看当日 submit path failed trade_audit 失败诊断复盘
- `submit-once-pingan-submit-path-rejection-review`
  - 完整提交流程后继续回看当日平安券商 submit path rejected trade_audit 拒单诊断复盘
- `submit-once-pingan-submit-path-failure-review`
  - 完整提交流程后继续回看当日平安券商 submit path failed trade_audit 失败诊断复盘
...
- `guarded-pingan-buy-order-exception-review`
  - 受保护买入后继续回看当日平安券商 buy + sell rejected + failed trade_audit 异常复盘
- `guarded-buy-order-rejection-review`
  - 受保护买入后继续回看当日 buy + sell rejected trade_audit 拒单诊断复盘
- `guarded-buy-order-failure-review`
  - 受保护买入后继续回看当日 buy + sell failed trade_audit 失败诊断复盘
