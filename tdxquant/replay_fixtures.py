...
_PROVIDER_REPLAY_FIXTURE_REGISTRY: list[dict[str, str]] = [
    ...
    {
        "name": "market-market-snapshot-success",
        "capability": "market.market_snapshot",
        "format": "json",
        "description": "Representative successful market.market_snapshot provider response sample.",
    ...
    {
        "name": "meta-ipo-info-success",
        "capability": "meta.ipo_info",
        "format": "json",
        "description": "Representative successful meta.ipo_info provider response sample.",
        "relative_path": "meta-ipo-info-success.json",
    },
    {
        "name": "meta-gp-one-success",
        "capability": "meta.gp_one_data",
        "format": "json",
        "description": "Representative successful meta.gp_one_data provider response sample.",
    ...
    {
        "name": "transaction-stock-transaction-data-by-date-success",
        "capability": "transaction.stock_transaction_data_by_date",
        "format": "json",
        "description": "Representative successful transaction.stock_transaction_data_by_date provider response sample.",
        "relative_path": "transaction-stock-transaction-data-by-date-success.json",
    },
    {
    ...
    {
        "name": "transaction-sector-transaction-data-success",
        "capability": "transaction.sector_transaction_data",
        "format": "json",
        "description": "Representative successful transaction.sector_transaction_data provider response sample.",
        "relative_path": "transaction-sector-transaction-data-success.json",
    },
    {
        "name": "transaction-sector-transaction-data-by-date-success",
        "capability": "transaction.sector_transaction_data_by_date",
        "format": "json",
        "description": "Representative successful transaction.sector_transaction_data_by_date provider response sample.",
        "relative_path": "transaction-sector-transaction-data-by-date-success.json",
    },
    {
