...
- report presets：`audit-daily-review` / `audit-daily-confirmed` / `audit-daily-rejected` / `audit-daily-replayed` / `audit-daily-failed` / `audit-daily-exceptions` / `audit-daily-confirm-exceptions` / `audit-daily-submit-once-exceptions` / `audit-daily-buy-exceptions` / `audit-daily-sell-exceptions` / `audit-daily-submit-path-exceptions` / `audit-daily-pingan-submit-path-exceptions` / `audit-daily-pingan-order-exceptions` / `audit-period-review` / `audit-period-confirmed` / `audit-period-rejected` / `audit-period-replayed` / `audit-period-failed` / `audit-period-exceptions` / `audit-period-confirm-exceptions` / `audit-period-submit-once-exceptions` / `audit-period-buy-exceptions` / `audit-period-sell-exceptions` / `audit-period-submit-path-exceptions` / `audit-period-pingan-submit-path-exceptions` / `audit-period-pingan-order-exceptions`
