...
- `trade_audit` 日常入口已覆盖 confirm-current single-status `confirm_current + rejected` / `confirm_current + failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 `buy_submit_once + rejected|failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 submit-once single-status `buy_submit_once + rejected` / `buy_submit_once + failed` 的多维异常视角
...
- `trade_audit` 日常入口已覆盖 order single-status path `buy|sell + rejected` / `buy|sell + failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped buy path `pingan + buy + rejected|failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped full review `pingan` 的全状态复盘视角
...
- `trade_audit` 日常入口已覆盖 broker-scoped submit-once single-status `pingan + buy_submit_once + rejected` / `pingan + buy_submit_once + failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped submit path `pingan + buy_submit_once + confirm_current + rejected|failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped submit path single-status `pingan + buy_submit_once|confirm_current + rejected` / `pingan + buy_submit_once|confirm_current + failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped order path `pingan + buy|sell + rejected|failed` 的多维异常视角
- `trade_audit` 日常入口已覆盖 broker-scoped order single-status path `pingan + buy|sell + rejected` / `pingan + buy|sell + failed` 的多维异常视角
- report presets：`audit-daily-review` / `audit-daily-pingan-review` / `audit-daily-confirmed` / `audit-daily-pingan-confirmed` / `audit-daily-rejected` / `audit-daily-pingan-rejected` / `audit-daily-replayed` / `audit-daily-pingan-replayed` / `audit-daily-failed` / `audit-daily-pingan-failed` / `audit-daily-exceptions` / `audit-daily-pingan-exceptions` / `audit-daily-confirm-exceptions` / `audit-daily-confirm-rejected` / `audit-daily-confirm-failed` / `audit-daily-pingan-confirm-exceptions` / `audit-daily-pingan-confirm-rejected` / `audit-daily-pingan-confirm-failed` / `audit-daily-submit-once-exceptions` / `audit-daily-submit-once-rejected` / `audit-daily-submit-once-failed` / `audit-daily-pingan-submit-once-exceptions` / `audit-daily-pingan-submit-once-rejected` / `audit-daily-pingan-submit-once-failed` / `audit-daily-buy-exceptions` / `audit-daily-pingan-buy-exceptions` / `audit-daily-sell-exceptions` / `audit-daily-pingan-sell-exceptions` / `audit-daily-submit-path-exceptions` / `audit-daily-submit-path-rejected` / `audit-daily-submit-path-failed` / `audit-daily-pingan-submit-path-exceptions` / `audit-daily-pingan-submit-path-rejected` / `audit-daily-pingan-submit-path-failed` / `audit-daily-order-exceptions` / `audit-daily-order-rejected` / `audit-daily-order-failed` / `audit-daily-pingan-order-exceptions` / `audit-daily-pingan-order-rejected` / `audit-daily-pingan-order-failed` / `audit-period-review` / `audit-period-pingan-review` / `audit-period-confirmed` / `audit-period-pingan-confirmed` / `audit-period-rejected` / `audit-period-pingan-rejected` / `audit-period-replayed` / `audit-period-pingan-replayed` / `audit-period-failed` / `audit-period-pingan-failed` / `audit-period-exceptions` / `audit-period-pingan-exceptions` / `audit-period-confirm-exceptions` / `audit-period-confirm-rejected` / `audit-period-confirm-failed` / `audit-period-pingan-confirm-exceptions` / `audit-period-pingan-confirm-rejected` / `audit-period-pingan-confirm-failed` / `audit-period-submit-once-exceptions` / `audit-period-submit-once-rejected` / `audit-period-submit-once-failed` / `audit-period-pingan-submit-once-exceptions` / `audit-period-pingan-submit-once-rejected` / `audit-period-pingan-submit-once-failed` / `audit-period-buy-exceptions` / `audit-period-pingan-buy-exceptions` / `audit-period-sell-exceptions` / `audit-period-pingan-sell-exceptions` / `audit-period-submit-path-exceptions` / `audit-period-submit-path-rejected` / `audit-period-submit-path-failed` / `audit-period-pingan-submit-path-exceptions` / `audit-period-pingan-submit-path-rejected` / `audit-period-pingan-submit-path-failed` / `audit-period-order-exceptions` / `audit-period-order-rejected` / `audit-period-order-failed` / `audit-period-pingan-order-exceptions` / `audit-period-pingan-order-rejected` / `audit-period-pingan-order-failed`
- catalog entries：`audit-daily-review` / `audit-daily-pingan-review` / `audit-daily-confirmed` / `audit-daily-pingan-confirmed` / `audit-daily-rejected` / `audit-daily-pingan-rejected` / `audit-daily-replayed` / `audit-daily-pingan-replayed` / `audit-daily-failed` / `audit-daily-pingan-failed` / `audit-daily-exceptions` / `audit-daily-pingan-exceptions` / `audit-daily-confirm-exceptions` / `audit-daily-confirm-rejected` / `audit-daily-confirm-failed` / `audit-daily-pingan-confirm-exceptions` / `audit-daily-pingan-confirm-rejected` / `audit-daily-pingan-confirm-failed` / `audit-daily-submit-once-exceptions` / `audit-daily-submit-once-rejected` / `audit-daily-submit-once-failed` / `audit-daily-pingan-submit-once-exceptions` / `audit-daily-pingan-submit-once-rejected` / `audit-daily-pingan-submit-once-failed` / `audit-daily-buy-exceptions` / `audit-daily-pingan-buy-exceptions` / `audit-daily-sell-exceptions` / `audit-daily-pingan-sell-exceptions` / `audit-daily-submit-path-exceptions` / `audit-daily-submit-path-rejected` / `audit-daily-submit-path-failed` / `audit-daily-pingan-submit-path-exceptions` / `audit-daily-pingan-submit-path-rejected` / `audit-daily-pingan-submit-path-failed` / `audit-daily-order-exceptions` / `audit-daily-order-rejected` / `audit-daily-order-failed` / `audit-daily-pingan-order-exceptions` / `audit-daily-pingan-order-rejected` / `audit-daily-pingan-order-failed` / `audit-period-review` / `audit-period-pingan-review` / `audit-period-confirmed` / `audit-period-pingan-confirmed` / `audit-period-rejected` / `audit-period-pingan-rejected` / `audit-period-replayed` / `audit-period-pingan-replayed` / `audit-period-failed` / `audit-period-pingan-failed` / `audit-period-exceptions` / `audit-period-pingan-exceptions` / `audit-period-confirm-exceptions` / `audit-period-confirm-rejected` / `audit-period-confirm-failed` / `audit-period-pingan-confirm-exceptions` / `audit-period-pingan-confirm-rejected` / `audit-period-pingan-confirm-failed` / `audit-period-submit-once-exceptions` / `audit-period-submit-once-rejected` / `audit-period-submit-once-failed` / `audit-period-pingan-submit-once-exceptions` / `audit-period-pingan-submit-once-rejected` / `audit-period-pingan-submit-once-failed` / `audit-period-buy-exceptions` / `audit-period-pingan-buy-exceptions` / `audit-period-sell-exceptions` / `audit-period-pingan-sell-exceptions` / `audit-period-submit-path-exceptions` / `audit-period-submit-path-rejected` / `audit-period-submit-path-failed` / `audit-period-pingan-submit-path-exceptions` / `audit-period-pingan-submit-path-rejected` / `audit-period-pingan-submit-path-failed` / `audit-period-order-exceptions` / `audit-period-order-rejected` / `audit-period-order-failed` / `audit-period-pingan-order-exceptions` / `audit-period-pingan-order-rejected` / `audit-period-pingan-order-failed`
- audit bundles：`audit-diagnostics` / `audit-pingan-review` / `audit-rejection-diagnostics` / `audit-pingan-rejection-diagnostics` / `audit-confirmed-review` / `audit-pingan-confirmed-review` / `audit-replay-review` / `audit-pingan-replay-review` / `audit-failure-diagnostics` / `audit-pingan-failure-diagnostics` / `audit-exception-diagnostics` / `audit-pingan-exception-diagnostics` / `audit-confirm-exception-diagnostics` / `audit-confirm-rejection-diagnostics` / `audit-confirm-failure-diagnostics` / `audit-pingan-confirm-exception-diagnostics` / `audit-pingan-confirm-rejection-diagnostics` / `audit-pingan-confirm-failure-diagnostics` / `audit-submit-once-exception-diagnostics` / `audit-submit-once-rejection-diagnostics` / `audit-submit-once-failure-diagnostics` / `audit-pingan-submit-once-exception-diagnostics` / `audit-pingan-submit-once-rejection-diagnostics` / `audit-pingan-submit-once-failure-diagnostics` / `audit-buy-exception-diagnostics` / `audit-pingan-buy-exception-diagnostics` / `audit-sell-exception-diagnostics` / `audit-pingan-sell-exception-diagnostics` / `audit-submit-path-exception-diagnostics` / `audit-submit-path-rejection-diagnostics` / `audit-submit-path-failure-diagnostics` / `audit-pingan-submit-path-exception-diagnostics` / `audit-pingan-submit-path-rejection-diagnostics` / `audit-pingan-submit-path-failure-diagnostics` / `audit-order-exception-diagnostics` / `audit-order-rejection-diagnostics` / `audit-order-failure-diagnostics` / `audit-pingan-order-exception-diagnostics` / `audit-pingan-order-rejection-diagnostics` / `audit-pingan-order-failure-diagnostics`
...
- split-step bundles：`submit-ready-audit-review` / `submit-ready-exception-review` / `submit-ready-pingan-audit-review` / `submit-ready-pingan-exception-review` / `submit-ready-order-exception-review` / `submit-ready-pingan-order-exception-review` / `submit-ready-order-rejection-review` / `submit-ready-order-failure-review` / `submit-ready-pingan-order-rejection-review` / `submit-ready-pingan-order-failure-review` / `confirm-audit-review` / `confirm-pingan-audit-review` / `confirm-complete-review` / `confirm-pingan-complete-review` / `confirm-exception-review` / `confirm-pingan-exception-review` / `confirm-rejection-review` / `confirm-failure-review` / `confirm-pingan-rejection-review` / `confirm-pingan-failure-review` / `confirm-order-exception-review` / `confirm-pingan-order-exception-review` / `confirm-order-rejection-review` / `confirm-order-failure-review` / `confirm-pingan-order-rejection-review` / `confirm-pingan-order-failure-review` / `submit-once-audit-review` / `submit-once-pingan-audit-review` / `submit-once-complete-review` / `submit-once-pingan-complete-review` / `submit-once-exception-review` / `submit-once-pingan-exception-review` / `submit-once-rejection-review` / `submit-once-failure-review` / `submit-once-pingan-rejection-review` / `submit-once-pingan-failure-review` / `submit-once-order-exception-review` / `submit-once-pingan-order-exception-review` / `submit-once-order-rejection-review` / `submit-once-order-failure-review` / `submit-once-pingan-order-rejection-review` / `submit-once-pingan-order-failure-review` / `guarded-buy-audit-review` / `guarded-pingan-buy-audit-review` / `guarded-buy-complete-review` / `guarded-pingan-buy-complete-review` / `guarded-buy-exception-review` / `guarded-pingan-buy-exception-review` / `guarded-buy-order-exception-review` / `guarded-pingan-buy-order-exception-review` / `guarded-buy-order-rejection-review` / `guarded-buy-order-failure-review` / `guarded-pingan-buy-order-rejection-review` / `guarded-pingan-buy-order-failure-review` / `confirm-submit-path-exception-review` / `confirm-pingan-submit-path-exception-review` / `confirm-submit-path-rejection-review` / `confirm-submit-path-failure-review` / `confirm-pingan-submit-path-rejection-review` / `confirm-pingan-submit-path-failure-review`
...
- trade_audit 多维复盘入口已补齐平安全状态视角：新增 `audit-daily-pingan-review` / `audit-period-pingan-review` report presets、catalog entries 和 `audit-pingan-review` bundle。
...
- trade_audit 多维复盘入口已补齐平安单状态 review 视角：新增 `audit-daily-pingan-confirmed` / `audit-period-pingan-confirmed` / `audit-daily-pingan-replayed` / `audit-period-pingan-replayed` report presets、catalog entries 和 `audit-pingan-confirmed-review` / `audit-pingan-replay-review` bundles。
...
- trade_audit 多维诊断入口的 submit-once single-status 诊断入口已补齐：新增 `audit-daily-submit-once-rejected` / `audit-period-submit-once-rejected` / `audit-daily-submit-once-failed` / `audit-period-submit-once-failed` / `audit-daily-pingan-submit-once-rejected` / `audit-period-pingan-submit-once-rejected` / `audit-daily-pingan-submit-once-failed` / `audit-period-pingan-submit-once-failed` report presets、catalog entries 和对应 diagnostics bundles。
- trade_audit 多维诊断入口已补齐订单侧 buy/sell 组合：新增 `audit-daily-order-exceptions` / `audit-period-order-exceptions` report presets、catalog entries 和 `audit-order-exception-diagnostics` bundle。
- trade_audit 多维诊断入口已补齐订单侧单状态组合：新增 `audit-daily-order-rejected` / `audit-period-order-rejected` / `audit-daily-order-failed` / `audit-period-order-failed` report presets、catalog entries 和 `audit-order-rejection-diagnostics` / `audit-order-failure-diagnostics` bundles。
...
- trade_audit 多维诊断入口已补齐平安订单侧单状态组合：新增 `audit-daily-pingan-order-rejected` / `audit-period-pingan-order-rejected` / `audit-daily-pingan-order-failed` / `audit-period-pingan-order-failed` report presets、catalog entries 和 `audit-pingan-order-rejection-diagnostics` / `audit-pingan-order-failure-diagnostics` bundles。
...
- 分步交易 workflow 的 confirm-current single-status follow-up 已补齐：新增 `confirm-rejection-review` / `confirm-failure-review` / `confirm-pingan-rejection-review` / `confirm-pingan-failure-review` catalog bundles，复用既有 `task-confirm-current` 和 confirm-current single-status audit review entry。
- 分步交易 workflow 的 confirm-current order exception follow-up 已补齐：新增 `confirm-order-exception-review` 与 `confirm-pingan-order-exception-review` catalog bundles，复用既有 `task-confirm-current` 和 order exception audit review entry。
- 分步交易 workflow 的 confirm-current order single-status follow-up 已补齐：新增 `confirm-order-rejection-review` / `confirm-order-failure-review` / `confirm-pingan-order-rejection-review` / `confirm-pingan-order-failure-review` catalog bundles，复用既有 `task-confirm-current` 和 order single-status audit review entry。
- 完整提交流程 workflow 的 submit-once full review follow-up 已补齐：新增 `submit-once-audit-review` 与 `submit-once-pingan-audit-review` catalog bundles，复用既有 `task-submit-once` 和 audit review entry。
- 完整提交流程 workflow 的 submit-once single-status follow-up 已补齐：新增 `submit-once-rejection-review` / `submit-once-failure-review` / `submit-once-pingan-rejection-review` / `submit-once-pingan-failure-review` catalog bundles，复用既有 `task-submit-once` 和 submit-once single-status audit review entry。
- 受保护买入 workflow 的 guarded-buy full review follow-up 已补齐：新增 `guarded-buy-audit-review` 与 `guarded-pingan-buy-audit-review` catalog bundles，复用既有 `guarded-buy` 和 audit review entry。
- 分步交易 workflow 的 PingAn confirm-current complete follow-up 已补齐：新增 `confirm-pingan-complete-review` catalog bundle，复用既有 `task-confirm-current`、`daily-success` 和 `audit-daily-pingan-confirmed`。
...
- 分步交易 workflow 的 confirm-current submit path single-status follow-up 已补齐：新增 `confirm-submit-path-rejection-review` / `confirm-submit-path-failure-review` / `confirm-pingan-submit-path-rejection-review` / `confirm-pingan-submit-path-failure-review` catalog bundles，复用既有 `task-confirm-current` 和 submit path single-status audit review entry。
